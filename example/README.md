...
The example uses six GWAS summary statistics from European genetic ancestry populations, that can be downloaded from the GWAS catalog and placed in the `data/` directory:
...
Next, the user can download the LD reference files for LDSC (EUR) and LAVA (UKB), as indicated in the [main documentation page](https://github.com/ape4fld/nf-genetic-correlations).
